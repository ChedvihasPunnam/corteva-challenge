...
from app.models import Base, engine, SessionLocal, WeatherRecord, WeatherStats
...
def compute_and_store_stats():
    ...
    precip_cm = case(
        (WeatherRecord.precip_mm_tenths != -9999, WeatherRecord.precip_mm_tenths / 100.0),
        else_=None
    )
...
if __name__ == "__main__":
    ...
    logger.info(f"Analysis finished at {end.isoformat()} — elapsed {(end-start).total_seconds():.2f}s")
